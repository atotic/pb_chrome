...
$DAEMON --user=deploy --errlog=${LOGDIR}errlog.log --dbglog=${LOGDIR}dbglog.log --output=${LOGDIR}output.log --stdout=${LOGDIR}stdout.log --stderr=${LOGDIR}stderr.log -- $CHROME_BIN --user-data-dir=${CHROME_PROFILE} --no-sandbox "$@"
